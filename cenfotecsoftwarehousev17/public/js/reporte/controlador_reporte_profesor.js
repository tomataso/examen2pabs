...
function ListarHoras(){
    ...
    if(dropCuatrimestres.value == "defecto"){
        ...
        swal({
            ...
            text: 'Por favor, seleccionar el cuatrimestre que desea visualizar las horas registradas por estudiante.',
        ...
        swal({
            type : 'warning',
            title : 'No hay horas registradas por ningún estudiante',
            text: 'No existen horas registradas hacia ningún estudiante asociado al profesor',
            confirmButtonText : 'Entendido'
        });
    ...
    for(let i = 0; i < listaDatos.length; i++){
                ...
                let cedula = fila.insertCell();
                let nombre = fila.insertCell();
                let totalHoras = fila.insertCell();
                
                cedula.innerHTML = listaDatos[i]['cedula'];
