...
btnProfesoresProyecto.addEventListener('click',function(){
    ...
    window.location.replace('../../html/proyecto/proyecto_profesores_asignados_estudiante.html');
    
});

btnEstudiantesProyecto.addEventListener('click',function(){

    window.location.replace('../../html/proyecto/proyecto_estudiantes_asignados_estudiante.html');
