        ...
        if (result.value) {   
          ...
          swalWithBootstrapButtons(
            ...
            'error'
                  ...
                  // OJO ----------------------------------------------------------------------------
                  ftnMostrarpersona(personaSeleccionado._id,obtenerListapersonaes());
...
window.onload = function(){
    ...
    let personaes = obtenerListapersonaes();

    ftnMostrarpersona(idpersona,personaes);
    ftnDeshabilitarCampos();
};



function ftnMostrarpersona (idpersona,personaes){

    let personaftnSeleccionado = null;

    personaes.forEach(element => {
